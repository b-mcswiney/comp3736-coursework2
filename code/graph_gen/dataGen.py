...
def get_gold_medal_data():
    return [r.randint(36, 48), r.randint(19, 29), r.randint(8, 14), r.randint(7, 12), r.randint(11, 17)]
...
def get_bronze_medal_data():
    return [r.randint(30, 38), r.randint(17, 19), r.randint(10, 17), r.randint(8, 21), r.randint(13, 15)]
